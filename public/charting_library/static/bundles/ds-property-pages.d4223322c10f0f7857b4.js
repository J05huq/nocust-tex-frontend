      ...
      (o._createRow_hhists = function(e, t) {
        ...
        $('<td>')
          ...
          $('<td>')
            .append(s)
            .appendTo(_),
          this.bindControl(new b(s, t.valuesColor, !0, this.model(), 'Change ' + u + ' Text Color'))
        for (d in t.colors)
      ...
      i(866),
        ...
        (n.prototype.saveData = function() {
          ...
          for (this._model.beginUndoMacro(), e = 0; e < this._bindings.length; e++)
            (t = this._bindings[e]), t.changed() && this._model.setProperty(t.property(), t.value())
        ...
        (y.prototype.value = function() {
          ...
          if (this._transformFunction)
            if (Array.isArray(this._transformFunction))
              for (e = 0; e < this._transformFunction.length; e++) t = this._transformFunction[e](t)
