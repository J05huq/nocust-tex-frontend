          ...
          (e.prototype.draw = function(e) {
            if (
              ...
              if (
                ...
                e.fillStyle = Object(s.generateColor)(this._data.color, this._data.transparency, !0)
              e.fill()
            }
          }),
          (e.prototype.hitTest = function(e) {
    ...
    inherit(n, r),
      ...
      (n.prototype.renderer = function() {
        ...
        for (
          ...
          (l = s(this._points[a - 1], this._points[a], 0)), (p = new o()), p.setData(l), t.append(p)
        return (
          this._points.length >= 5 &&
            ((f = !1),
            (g = !1),
    ...
    inherit(n, s),
      (n.prototype.renderer = function() {
        ...
        for (
          ...
          (l = s(this._points[o - 1], this._points[o], 0)), (c = new r()), c.setData(l), t.append(c)
        return (
          this._retrace1 &&
    ...
    ;(n.prototype.setData = function(e) {
      ...
      (n.prototype._drawCloseButton = function(e, t, i) {
        ...
        e.save(),
          ...
          (h = (this._height() - a) / 2),
          CanvasEx.drawPoly(e, [{ x: t + l, y: i + h }, { x: r - l, y: o - h }], !0),
          CanvasEx.drawPoly(e, [{ x: r - l, y: i + h }, { x: t + l, y: o - h }], !0),
          this._adapter._blocked &&
            ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'),
            e.fillRect(t + 0.5, i + 0.5, n - 1, s - 1)),
          e.restore()
    ...
    ;(n.prototype.setData = function(e) {
      ...
      (n.prototype._drawCancelButton = function(e, t, i, n) {
        ...
        ;(e.strokeStyle = this._adapter.getCancelButtonBorderColor()),
          ...
          (d = (this._height() - l) / 2),
          CanvasEx.drawPoly(e, [{ x: t + h, y: i + d }, { x: o - h, y: a - d }], !0),
          CanvasEx.drawPoly(e, [{ x: o - h, y: i + d }, { x: t + h, y: a - d }], !0)
      }),
      (n.prototype.draw = function(e) {
        var t, i, n, s, r, o, a, l, h, d, c
        null === this._data ||
