!(function(e, t) {
  ...
  var m =
    ...
    (b.prototype._requestConfiguration = function() {
      return this._send('config').catch(function(e) {
        return (
          n(
            'UdfCompatibleDatafeed: Cannot get datafeed configuration - use default, error=' + c(e),
          ),
          null
        )
      })
  ...
  var y =
    ((v.prototype.getQuotes = function(e) {
      var s = this
      return new Promise(function(t, r) {
        s._requester
  ...
  var q,
    ...
    S =
      (t((q = k), (w = D = m)),
      void (q.prototype = null === w ? Object.create(w) : ((x.prototype = w.prototype), new x())),
      k)
  function x() {
    this.constructor = q
  }
  ...
  ;(e.UDFCompatibleDatafeed = S), Object.defineProperty(e, '__esModule', { value: !0 })
})
